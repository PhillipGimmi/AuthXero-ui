...
const dummyPreviousPeriodData: DataPoint[] = Array.from(
  { length: 24 },
  (_, i) => ({
    ...
    return (
      ...
      >
        <div style={{ flex: '1', textAlign: 'left' }}>
          ...
          <div
            style={{ fontSize: '24px', fontWeight: 'bold', margin: '4px 0' }}
          >
...
const StatsCard: React.FC<StatsCardProps> = ({ stat, index }) => {
  ...
  return (
    <motion.div
      layout
      className="w-full bg-[#1A1A1A] rounded-xl border border-zinc-800 overflow-hidden"
      ...
      >
        ...
        {tooltipConfig && (
          <CustomTooltip
            ...
            mousePosition={tooltipConfig.position}
          />
        )}
      </button>
    </motion.div>
