...
const CustomTooltip: React.FC<CustomTooltipProps> = ({
  ...
  const theme = useTheme();
  const baseColor =
    color === theme.primary.main ? theme.primary : theme.secondary;
...
const generateGradientDefinitions = (theme: ThemeColors) => (
  <defs>
    <linearGradient id="colorUsers" x1="0" y1="0" x2="0" y2="1">
      <stop
        offset="5%"
        stopColor={theme.primary.gradient.start}
        stopOpacity={0.4}
      />
      <stop
        offset="95%"
        stopColor={theme.primary.gradient.end}
        stopOpacity={0.1}
      />
    </linearGradient>
    <linearGradient id="colorLogins" x1="0" y1="0" x2="0" y2="1">
      <stop
        offset="5%"
        stopColor={theme.secondary.gradient.start}
        stopOpacity={0.4}
      />
      <stop
        offset="95%"
        stopColor={theme.secondary.gradient.end}
        stopOpacity={0.1}
      />
    </linearGradient>
